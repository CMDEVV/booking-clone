...
const products = [
  {
    name: "Book a Stay",
    description: "Get a better underastanding",
    href: "#",
    icon: HomeIcon,
  },
  {
...
function Header() {
  ...
  return (
    <header className="bg-[#013B94]">
      <nav
        className="mx-auto flex max-w-7x1 items-center justify-between p-6 lg:px-8"
        aria-label="Global"
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            <Transition
              ...
              enterTo="opcaity-100 translate-y-0"
      ...
      >
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013B94] px-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10"></Dialog.Panel>
      </Dialog>
    </header>
  );
}
